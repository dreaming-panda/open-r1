...
class Qwen2Attention(nn.Module):
    ...
    def __init__(self, config: Qwen2Config, layer_idx: int):
        ...
        self.trans_k = nn.Parameter(torch.zeros(config.num_key_value_heads, self.head_dim, self.num_key_value_groups * self.head_dim))
        self.trans_v = nn.Parameter(torch.zeros(config.num_key_value_heads, self.head_dim, self.num_key_value_groups * self.head_dim))
    def forward(
        self,
