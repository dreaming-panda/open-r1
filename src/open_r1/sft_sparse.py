...
def main(script_args, training_args, model_args):
    ...
    config.sliding_window_freq=model_args.sliding_window_freq
    config.sliding_window=model_args.sliding_window
...
if __name__ == "__main__":
    parser = TrlParser((ScriptArguments, SFTConfig, SparseModelConfig))
