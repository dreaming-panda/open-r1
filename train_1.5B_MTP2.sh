...
accelerate launch --config_file recipes/accelerate_configs/zero3.yaml src/open_r1/sft_mtp2.py  --config recipes/OpenR1-Qwen-7B/sft/config1.5BMTP3.yaml

ls /fsx-storygen/jwzhao/checkpoints/Qwen1.5B-MTP-S24E28NC1
